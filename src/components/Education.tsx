...
const Education = () => {
  const { ref, inView } = useInView({
    triggerOnce: true, // Solo se activa la animación la primera vez que entra en vista
  ...
  return (
    ...
    >
      <div
        className={`max-w-5xl text-center md:text-left transition-all duration-700 ${
